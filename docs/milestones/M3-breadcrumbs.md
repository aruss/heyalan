...
- [ ] Add admin breadcrumb map module (`HeyAlan.WebApp/src/lib/admin-breadcrumbs.ts`) with a named export for resolving items from a pathname.
...
- [ ] Update `HeyAlan.WebApp/src/components/admin/ui/navigation/Breadcrumbs.tsx` to derive items from pathname using the route map.
...
- [ ] Remove breadcrumb `useEffect` setters from:
  - `HeyAlan.WebApp/src/app/admin/home/page.tsx`
  - `HeyAlan.WebApp/src/app/admin/inbox/page.tsx`
  - `HeyAlan.WebApp/src/app/admin/settings/page.tsx`
