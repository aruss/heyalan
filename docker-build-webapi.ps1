...
# Context Staging
$TempDir = Join-Path $env:TEMP "SquareBuddy_WebBuild_$(Get-Random)"
...
try {
    ...
    Copy-Clean "./SquareBuddy.WebApi" (Join-Path $TempDir "SquareBuddy.WebApi") $IgnorePathes
    ...
    docker build --no-cache `
        ...
        -f "SquareBuddy.WebApi/Dockerfile" `
        $TempDir
}
finally {
