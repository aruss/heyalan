...
try {
    ...
    Copy-Clean "./ShelfBuddy.Initializer" (Join-Path $TempDir "ShelfBuddy.Initializer") $IgnorePathes
    ...
    $ImageName = "shelfbuddy-initializer"
    ...
    docker build --no-cache `
        ...
        -f "ShelfBuddy.Initializer/Dockerfile" `
        $TempDir
}
finally {
